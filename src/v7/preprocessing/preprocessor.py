...
from src.v7.preprocessing.auditor import DataAuditor
from src.v7.preprocessing.feature_engineer import DataFeatureEngineer
from src.config.config import PREPROCESSING_LOGS_DIR
from src.utils.logger import Logger
from src.utils.utils import create_directory, resolve_preprocess_run_number
...
def main():
    dir_path = PREPROCESSING_LOGS_DIR / 'v7'
    run_number = resolve_preprocess_run_number(dir_path)
